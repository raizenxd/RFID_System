...
public class AttendanceService {
    ...
    private static final String EMAIL_PASSWORD = "opna mwyy novk xaan";
    ...
    public static void processAttendance(String rfid, String logType, JFrame owner) {
        try {
            if (rfid == null || rfid.trim().isEmpty()) {
                showTimedMessageDialog(owner, "Please scan or enter RFID number.", "Input Required", JOptionPane.WARNING_MESSAGE);
                return;
            }
